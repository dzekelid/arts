...
- name: Amazon Glacier API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/art/master/_listings/aws-glacier/accountid-vaults-vaultname-multipart-uploads-uploadid-delete.md
x-common:
- type: x-change-log
