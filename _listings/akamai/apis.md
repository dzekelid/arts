...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/art/master/_listings/akamai/events-v2-accountid-events-startrange,endrange,sortfield,sortorder,startindex,limit,customereventid-put.md
x-common:
- type: x-base
